...
#                clone(), move_by(), and move_center_to()
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                center, fill_color, outline_color
#
#     f. What does a RoseWindow RENDER method do?
#            The render method draws all of the functions attached to the window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            It is necessary always. This is because the window will close automatically without this method
#            this means you wouldn't be able to see your graphics once they are completed.
#
