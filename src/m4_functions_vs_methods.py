...
def try_methods_and_functions():
    ...
    gabe.pen = rg.Pen('blue', 5)
    gabe.backward(150)
    gabe.speed = 1
    draw_many_squares(gabe, 2, 100, 30)
    gabe.speed = 5
    gabe.pen = rg.Pen('red', 5)
    draw_many_squares(gabe, 10, 50, 15)
    gabe.speed = 100
    gabe.pen = rg.Pen('red', 35)
    draw_many_squares(gabe, 8, 300, 60)
    gabe.pen = rg.Pen('black', 3)
    gabe.backward(200)
    gabe.draw_circle(30)
    gabe.draw_square(50)
